...
export default function BuyNowCheckout() {
    ...
    const orderSummary = buyNowData ? {
        items: [{
            id: buyNowData.product.id,
            ...
            selectedSize: buyNowData.selectedSize,
        }],
        subtotal: buyNowData.product.price * buyNowData.quantity,
        deliveryFee: getDeliveryFee(),
        total: (buyNowData.product.price * buyNowData.quantity) + getDeliveryFee(),
    } : null;
    ...
    const handleOrderSubmit = async (paymentData) => {
        console.log("Buy Now order submitted:", paymentData);
