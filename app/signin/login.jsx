      ...
      <main className="flex flex-1 items-center justify-center px-6">
        <div className="flex max-w-4xl w-full rounded-lg overflow-hidden shadow-lg bg-white">
          ...
          <div className="w-full md:w-1/2 p-8">
            <h2 className="text-3xl font-bold mb-8 text-gray-900 text-center">Sign in</h2>
            <form>
              <div className="mb-6">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-400 transition"
              >
                Sign in
              </button>
            </form>
